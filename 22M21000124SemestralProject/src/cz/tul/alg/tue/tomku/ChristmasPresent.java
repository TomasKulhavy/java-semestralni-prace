...
/**
 * Vánoční úloha. Program se uživatele zeptá, jestli byl letos hodný. Podle odpovědi se buďto vykreslí vánoční dárek nebo krabice plná uhlí.
 */
public class ChristmasPresent {
    /**
     * Generování náhodného čísla v rozsahu min, max
     * @param min, integer. Číslo od kterého se má generovat náhodné číslo.
     * @param max, integer. Číslo do kterého se má generovat náhodné číslo.
     * @return náhodné číslo (Integer)
     */
    ...
    /**
     * Vykreslí vánoční úlohu
     */
    public static void DrawChristmasPresent() {
        String odpoved = "";
        System.out.println("Byl jsi letos hodný?");
        while (!(odpoved.equals("ano") || odpoved.equals("ne"))) {
            System.out.print("ANO/NE >>> ");
            odpoved = (Main.sc.nextLine()).toLowerCase(Locale.ROOT);
        }

        // Konstatny pro práci s barvou textu v konzoli.
